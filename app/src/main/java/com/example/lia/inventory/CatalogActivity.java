...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void insertBook() {
        ...
        // and Poems's book attributes are the values.
        ContentValues values = new ContentValues();
        values.put(BookEntry.COLUMN_BOOK_NAME, "Poems");
        ...
        // there are no values).
        // The third argument is the ContentValues object containing the info for Poems.
